...
navbarPage("Coal Mining in Mozambique | DP Algorithm",
           ...
           tabPanel("Modeling",
                    sidebarLayout(
                      sidebarPanel(
                        radioButtons("DP_choose", "DP Algorithm",
                                     c("Basis"="dp_basis",
                                       "Transport cost"="dp_transport")),
                        ...
                        sliderInput("TL", label = "Transport Limit", min = 10, 
                                    max = 200, value = 20),
                        sliderInput("S", label = "Salvage Cost", min = 0, 
                                    max = 1, value = 0.5),
                        ...
                        inputPanel(h4("Share of coking coal"),
                                   sliderInput("rho1", label = "Ncondezi", min = 0.01, 
                                               max = 1, value = 0.01),
                                   sliderInput("rho2", label = "Revobue", min = 0.01, 
                                               max = 1, value = 0.6),
                                   sliderInput("rho3", label = "Zambeze", min = 0.01, 
                                               max = 1, value = 0.6),
                                   sliderInput("rho4", label = "Beacon Hill", min = 0.01, 
                                               max = 1, value = 0.31),
                                   sliderInput("rho5", label = "Benga", min = 0.01, 
                                               max = 1, value = 0.6),
                                   sliderInput("rho6", label = "Moatize", min = 0.01, 
                                               max = 1, value = 0.8)
                        )
                      ),
                    mainPanel(
